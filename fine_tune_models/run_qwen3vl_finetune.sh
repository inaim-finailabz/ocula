...
set -euo pipefail
#
# Qwen3-VL-2B Vision Fine-tuning — Quick Run
# ============================================
...
echo -e "${BOLD}╔═══════════════════════════════════════════════════════╗${NC}"
echo -e "${BOLD}║  Qwen3-VL-2B Vision Fine-tuning Pipeline             ║${NC}"
echo -e "${BOLD}║  Pro Tier — Thinker — Document + Chart + Reasoning   ║${NC}"
echo -e "${BOLD}╚═══════════════════════════════════════════════════════╝${NC}"
echo ""
...
if ! $TRAIN_ONLY && should_run "data"; then
    echo -e "${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${GREEN}  STEP 1/5: Download & Prepare Qwen3-VL Vision Data${NC}"
    echo -e "${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""

    cd scripts
    "$PYTHON" 04a_prepare_qwen3vl_data.py --max-samples "$MAX_SAMPLES"
    cd ..
...
if should_run "train"; then
    echo ""
    echo -e "${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${GREEN}  STEP 2/5: Train Qwen3-VL (QLoRA, $BACKEND)${NC}"
    echo -e "${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    ...
    "$PYTHON" 04b_train_qwen3vl_vision.py "${TRAIN_ARGS[@]}"
...
if should_run "deploy" && $DEPLOY; then
    ...
    cd scripts
    "$PYTHON" 07c_export_qwen3vl_gguf.py --deploy --skip-projector
    cd ..
fi
...
echo ""
echo -e "${BOLD}═══════════════════════════════════════════════════════${NC}"
echo -e "${GREEN}  QWEN3-VL PIPELINE COMPLETE${NC}"
echo -e "${BOLD}═══════════════════════════════════════════════════════${NC}"
echo ""
echo -e "  Output GGUF:  models/gguf/"
echo -e "  Adapters:     models/lora_adapters/qwen3vl-vision*/"
echo -e "  Merged:       models/merged/qwen3vl-vision-merged/"
echo ""

if ! $DEPLOY; then
    echo -e "  ${YELLOW}To deploy to Ocula app:${NC}"
    echo -e "  ${CYAN}cp models/gguf/Qwen3-VL-2B-finetuned-Q4_K_M.gguf \\${NC}"
    echo -e "     ${CYAN}../ocula_app/assets/models/Qwen3-VL-2B-Q4_K_M.gguf${NC}"
    echo ""
fi
