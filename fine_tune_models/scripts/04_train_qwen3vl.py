#!/usr/bin/env python3
"""
Qwen3-VL-2B (Thinker) Fine-tuning Script
2B params — QLoRA (4-bit) for CUDA, LoRA for MLX
Flagship model — chain-of-thought reasoning.

Usage:
    python 04_train_qwen3vl.py                  # Auto-detect
    python 04_train_qwen3vl.py --backend mlx    # Apple Silicon
    python 04_train_qwen3vl.py --backend cuda   # NVIDIA GPU
"""
...
def load_config(config_path="../configs/qwen3vl.yaml"):
...
def main():
    parser = argparse.ArgumentParser(description="Qwen3-VL-2B Fine-tuning")
    parser.add_argument("--config", default="../configs/qwen3vl.yaml")
